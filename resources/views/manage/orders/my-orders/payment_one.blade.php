        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <h3><i class="fa fa-upload"></i> <strong>Payment Receipt Two</strong></h3>
                    <p><b><a href="{{ route('my-orders.index') }}">My Orders</a></b> <i class="fa fa-chevron-right fa-sm"></i>
                        <b>Upload Proof of Payment</b></p>
                </div>

                <div class="card-body"> 
                    <form class="form-horizontal" action="{{ route('my-orders.upload-paymentone', $order->id) }}" method="POST" enctype="multipart/form-data">
                        {{csrf_field()}}
                        {{method_field('PATCH')}}
                        ...
                        <div class="form-group pb-2">
                            <label for="payment_proof_one">Proof of Payment</label>
                            <input type="file" class="form-control-file pl-0" name="payment_proof_one">
                        </div>
